...
public class SettingsOption : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            menuController.ChangeScreen(menuController.SettingsOption, menuController.MainMenu);
            index = 0;
        }
    ...
    public void ChangeMenus() //switching menus,  similar to how change options is built
    {
        if (index == 0)
        {
            menuController.ChangeScreen(menuController.SettingsOption, menuController.SoundSelection);
        }
        ...
        {
            menuController.ChangeScreen(menuController.SettingsOption, menuController.ResolutionSelection);
        }
